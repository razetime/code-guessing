let input = [["contest","date held","winner","winner's second name"],
...
let hearing = (table) => {
         ...
         * BACK END *
         ************
         * i was out there mindin my own business when this muffuckuh decided ta ruin ma boys's groove!
         * punk ass bitch didun hafta kill my  mojo for the day, dude! he jus went up to ma freinds and 
         * started on the critical race theory dude!
         */
...
console.log(final_judgement(input));